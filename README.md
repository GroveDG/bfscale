...
## How to Use
bfscale only has one function: **bfscale.scale(img, target_size)**.
<ul>
  <li>Scales an image with dimension order (y, x, c) to a size of (target_size[0], target_size[1], c).</li>
</ul>
